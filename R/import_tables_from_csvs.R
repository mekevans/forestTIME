...
import_tables_from_csvs <- function(con, csv_dir) {
  ...
  plot_query <- paste0(
    "CREATE TABLE plot AS SELECT CN AS PLOT_CN, SRV_CN, CTY_CN, PREV_PLT_CN, INVYR, STATECD, UNITCD, COUNTYCD, PLOT, PLOT_STATUS_CD, PLOT_NONSAMPLE_REASN_CD, MEASYEAR, MEASMON, MEASDAY, REMPER, KINDCD, DESIGNCD, RDDISTCD, WATERCD, LAT, LON, ELEV, GROW_TYP_CD, MORT_TYP_CD, P2PANEL, P3PANEL, ECOSUBCD, CONGCD, MANUAL, KINDCD_NC, QA_STATUS, MICROPLOT_LOC, DECLINATION, EMAP_HEX, SAMP_METHOD_CD, SUBP_EXAMINE_CD, MACRO_BREAKPOINT_DIA, INTENSITY, CYCLE, SUBCYCLE, ECO_UNIT_PNW, TOPO_POSITION_PNW, NF_SAMPLING_STATUS_CD, NF_PLOT_STATUS_CD, NF_PLOT_NONSAMPLE_REASN_CD, P2VEG_SAMPLING_STATUS_CD, P2VEG_SAMPLING_LEVEL_DETAIL_CD, INVASIVE_SAMPLING_STATUS_CD, INVASIVE_SPECIMEN_RULE_CD, DESIGNCD_P2A, MANUAL_DB, SUBPANEL, COLOCATED_CD_RMRS, CONDCHNGCD_RMRS, FUTFORCD_RMRS, MANUAL_NCRS, MANUAL_NERS, MANUAL_RMRS, PAC_ISLAND_PNWRS, PLOT_SEASON_NERS, PRECIPITATION, PREV_MICROPLOT_LOC_RMRS, PREV_PLOT_STATUS_CD_RMRS, REUSECD1, REUSECD2, REUSECD3, CONCAT_WS('_', STATECD, UNITCD, COUNTYCD, PLOT) AS PLOT_COMPOSITE_ID FROM '",
    csv_dir,
    "/*_PLOT.csv' WHERE (INVYR >= 2000.0)")
  
  cond_query <- paste0(
    "CREATE TABLE cond AS SELECT CN AS COND_CN, PLT_CN, INVYR, STATECD, UNITCD, COUNTYCD, PLOT, CONDID, COND_STATUS_CD, COND_NONSAMPLE_REASN_CD, RESERVCD, OWNCD, OWNGRPCD, FORINDCD, ADFORCD, FORTYPCD, FLDTYPCD, MAPDEN, STDAGE, STDSZCD, FLDSZCD, SITECLCD, SICOND, SIBASE, SISP, STDORGCD, STDORGSP, PROP_BASIS, CONDPROP_UNADJ, MICRPROP_UNADJ, SUBPPROP_UNADJ, MACRPROP_UNADJ, SLOPE, ASPECT, PHYSCLCD, GSSTKCD, ALSTKCD, DSTRBCD1, DSTRBYR1, DSTRBCD2, DSTRBYR2, DSTRBCD3, DSTRBYR3, TRTCD1, TRTYR1, TRTCD2, TRTYR2, TRTCD3, TRTYR3, PRESNFCD, BALIVE, FLDAGE, ALSTK, GSSTK, FORTYPCDCALC, HABTYPCD1, HABTYPCD1_PUB_CD, HABTYPCD1_DESCR_PUB_CD, HABTYPCD2, HABTYPCD2_PUB_CD, HABTYPCD2_DESCR_PUB_CD, MIXEDCONFCD, VOL_LOC_GRP, SITECLCDEST, SITETREE_TREE, SITECL_METHOD, CARBON_DOWN_DEAD, CARBON_LITTER, CARBON_SOIL_ORG, CARBON_UNDERSTORY_AG, CARBON_UNDERSTORY_BG, CYCLE, SUBCYCLE, SOIL_ROOTING_DEPTH_PNW, GROUND_LAND_CLASS_PNW, PLANT_STOCKABILITY_FACTOR_PNW, STND_COND_CD_PNWRS, STND_STRUC_CD_PNWRS, STUMP_CD_PNWRS, FIRE_SRS, GRAZING_SRS, HARVEST_TYPE1_SRS, HARVEST_TYPE2_SRS, HARVEST_TYPE3_SRS, LAND_USE_SRS, OPERABILITY_SRS, STAND_STRUCTURE_SRS, NF_COND_STATUS_CD, NF_COND_NONSAMPLE_REASN_CD, CANOPY_CVR_SAMPLE_METHOD_CD, LIVE_CANOPY_CVR_PCT, LIVE_MISSING_CANOPY_CVR_PCT, NBR_LIVE_STEMS, OWNSUBCD, INDUSTRIALCD_FIADB, RESERVCD_5, ADMIN_WITHDRAWN_CD, CHAINING_CD, LAND_COVER_CLASS_CD_RET, AFFORESTATION_CD, PREV_AFFORESTATION_CD, DWM_FUELBED_TYPCD, NVCS_PRIMARY_CLASS, NVCS_LEVEL_1_CD, NVCS_LEVEL_2_CD, NVCS_LEVEL_3_CD, NVCS_LEVEL_4_CD, NVCS_LEVEL_5_CD, NVCS_LEVEL_6_CD, NVCS_LEVEL_7_CD, NVCS_LEVEL_8_CD, AGE_BASIS_CD_PNWRS, COND_STATUS_CHNG_CD_RMRS, CRCOVPCT_RMRS, DOMINANT_SPECIES1_PNWRS, DOMINANT_SPECIES2_PNWRS, DOMINANT_SPECIES3_PNWRS, DSTRBCD1_P2A, DSTRBCD2_P2A, DSTRBCD3_P2A, DSTRBYR1_P2A, DSTRBYR2_P2A, DSTRBYR3_P2A, FLDTYPCD_30, FOREST_COMMUNITY_PNWRS, LAND_USECD_RMRS, MAICF, PCTBARE_RMRS, QMD_RMRS, RANGETYPCD_RMRS, SDIMAX_RMRS, SDIPCT_RMRS, SDI_RMRS, STAND_STRUCTURE_ME_NERS, TREES_PRESENT_NCRS, TREES_PRESENT_NERS, TRTCD1_P2A, TRTCD2_P2A, TRTCD3_P2A, TRTOPCD, TRTYR1_P2A, TRTYR2_P2A, TRTYR3_P2A, LAND_COVER_CLASS_CD, SIEQN_REF_CD, SICOND_FVS, SIBASE_FVS, SISP_FVS, SIEQN_REF_CD_FVS, MQUADPROP_UNADJ, SOILPROP_UNADJ, FOREST_COND_STATUS_CHANGE_CD, CONCAT_WS('_', STATECD, UNITCD, COUNTYCD, PLOT) AS PLOT_COMPOSITE_ID FROM '",
    csv_dir,
