...
my_maple_timeseries <- get_timeseries(my_red_maples_one_plot, connection = 'local')
...
Using the `connection = "remote"` option pulls the data from remote sources rather than downloading it. 
