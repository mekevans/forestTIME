...
3. Download the file `treering.duckdb` and save it to `data/db/treering.duckdb`. [Link here (this will download 1.5 GB)](https://arizona.box.com/s/nlykl9rbchlk2bj9npjd8dej5iw06i8a)
