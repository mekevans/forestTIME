...
The forestTIME `tree` table contains *most* columns from the FIADB `TREE` table, filtered records for which `INVYR >= 2000`. 
...
* DEATH: T/F, whether this tree is ever recorded as dead (STATUSCD == 2).
* DISTURBANCE: T/F, whether this tree ever occurs on a condition with a distrubance code.
* DAMAGE: T/F, whether this tree ever has any DAMAGE codes recorded. 
...
* DIA_est_mort: Estimated DIA taking into account MORTYR.
* HT_est_mort: Estimated HT taking into account MORTYR.
* ACUTALHT_est_mort: Estimated ACTUALHT taking into account MORTYR. 
* last_MORTYR: Last (highest number) MORTYR recorded for this tree.
* STATUSCD: STATUSCD for the record on which this estimate is based.
* DEATH: T/F whether this tree has ever been recorded as dead.
* DAMAGE: T/F whether this tree has ever had any damage codes recorded. 
* DISTURBANCE: T/F whether this tree has ever been on a condition with a disturbance code.
...
* PREV_live_and_skipped: Count of saplings alive in PREV_INVYR, added to the count of saplings alive in previous INVYRS that were skipped in PREV_INVYR (but show up again this year).
...
* sapling_missing_data_prop: Proportion of live saplings in PREV_INVYR marked as alive, but missing DIA information, in INVYR.
* sapling_skipped_prop: Proportion of live saplings in PREV_INVYR not recorded in INVYR (but recorded in subsequent INVYRS). 
